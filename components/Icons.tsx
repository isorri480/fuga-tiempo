...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.566-.16-1.16-1.54-1.16-2.962v-2.24c0-1.421 1.72-2.8 1.16-2.962m3.84 5.922c.566-.16 1.16-1.54 1.16-2.962v-2.24c0-1.421-1.72-2.8-1.16-2.962m3.84 5.922-1.16-2.962m-1.16 2.962-3.84-5.922m0 0a9.043 9.043 0 0 1-1.16-2.962m1.16 2.962a9.043 9.043 0 0 0-1.16-2.962m-3.84 5.922a9.094 9.094 0 0 0-3.742-.479 3 3 0 0 0-4.682 2.72m7.5-2.962c-.566-.16-1.16-1.54-1.16-2.962V8.64c0-1.421 1.72-2.8 1.16-2.962m-3.84 5.922 1.16-2.962" />
  </svg>
);
...
export const ArrowRightStartOnRectangleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
